   ...
   <div class="container">
      <div class="row">
         <div class="col-sm-8 col-sm-offset-2 centre-align push_down">
            ...
            <p>
                Code released under the OmeletteDuFromage license. Copyright (c) ${currentYear} .
            </p>
            <p>
               <a href="https://github.com/Violia/BilboquetForeverStore"><span class="fa fa-github fa-2x"></span></a>
            </p>
         </div>
      </div>
   </div>	
