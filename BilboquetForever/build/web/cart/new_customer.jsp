...
<%@taglib prefix="pwet" uri="/WEB-INF/customTags.tld" %>
      ...
      <div class="col-sm-8 col-sm-offset-2">
         ...
         <form method="post" action="<c:url value='/order/processCustomer' />">
            <div class="form-group">
               ...
               <pwet:ifEmptyPutAsterisk field="${customer.firstName}" />
               <input type="text" name="firstName" id="firstName" class="form-control" 
                      value="<c:out value='${customer.firstName}' />" required="true" />              
            </div>
            <div class="form-group">
               <label for="lastName">Last Name:</label>
               <pwet:ifEmptyPutAsterisk field="${customer.lastName}" />
               <input type="text" name="lastName" id="lastName" class="form-control" 
                      value="<c:out value='${customer.lastName}' />" required="true" />
            </div>
            <div class="form-group">
               <label for="email">Email:</label>
               <pwet:ifEmptyPutAsterisk field="${customer.email}" />
            ...
            <div class="form-group">
               ...
               <pwet:ifEmptyPutAsterisk field="${customer.address.address1}" />
            ...
            <div class="form-group">
               ...
               <pwet:ifEmptyPutAsterisk field="${customer.address.city}" />
               <input type="text" name="city" id="city" class="form-control" 
                      value="<c:out value='${customer.address.city}' />" required="true" />
            </div>
            <div class="form-group">
               <label for="postCode">Post Code:</label>
               <pwet:ifEmptyPutAsterisk field="${customer.address.postCode}" />
               <input type="text" name="postCode" id="postCode" class="form-control" 
                      value="<c:out value='${customer.address.postCode}' />" required="true" />
            </div>
            <div class="form-group">
               <label for="country">Country:</label>
               <pwet:ifEmptyPutAsterisk field="${customer.address.country}" />
